...
impl List {
    ...
    fn len(&self) -> u32 {
        // `self` has to be matched, because the behaviour of this method depends on the variant
        // of `self`. `self` has type `&List`, and `*self` has type `List`, matching on a concrete
