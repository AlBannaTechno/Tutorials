...
// So, this implements the 'Add' Trait for the Type 'Length'
// The 'Add' Trait overloads the addition operator so elements can be added together.
// 'X: Y' applies a restriction to 'X' and only allows operations to 'X' if 'X' implements the
// trait 'Y'.
// This means that this 'impl' defines 'Add' only for 'T' when two 'T's' can be added together and
// the result is of Type 'T': ('T: Add<T, T>').
