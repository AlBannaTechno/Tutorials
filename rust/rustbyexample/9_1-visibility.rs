...
fn main() {
    ...
    // Public items inside public nested modules can be accessed from outside the parent module
    my::nested::function();
    ...
    // Items inside private nested modules can't be accessed, regardless of their visibility
    // Error! `inaccessable` is a private module
