...
# ------------------------------------------------------------------------
# Modified by Al Kabaila for "Simple Editor" tutorial project 2010.
# All mistakes are surely mine, not Mark Summerfield's (author of 
# autoritative text "Rapid GUI Programming with Python and Qt")
# ------------------------------------------------------------------------
