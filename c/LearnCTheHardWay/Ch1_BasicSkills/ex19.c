...
void *Map_move(void *self, Direction direction)
{
    ...
    // location->proto.move(location, direction);
...
int Map_attack(void *self, int damage)
{
    ...
    // location->proto.attack(location, damage);
...
int Map_init(void *self)
{
    ...
    // Room *kitched = Object_new(sizeof(Room), RoomProto, "Kitched, you have the knife now.");
